...
export default function Home() {
  return (
    <div>
      <section className="bg-gradient-to-b from-sky-400 via-sky-300 to-sky-200 text-slate-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mb-6">
            <span className="text-6xl sm:text-7xl inline-block animate-bounce">✈️</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-slate-800">
            {siteConfig.name}
          </h1>
          <p className="text-xl sm:text-2xl mb-8 max-w-3xl mx-auto font-semibold text-slate-700">
      ...
      <section className="bg-white/50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">¿Por qué SocorroDigital?</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-6 border-2 border-sky-100 hover:border-sky-300 transition-all">
              <div className="text-5xl mb-4">💯</div>
              <h3 className="text-xl font-bold mb-2 text-slate-800">100% Gratuito</h3>
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-6 border-2 border-sky-100 hover:border-sky-300 transition-all">
              <div className="text-5xl mb-4">📝</div>
              <h3 className="text-xl font-bold mb-2 text-slate-800">Paso a paso</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-6 border-2 border-sky-100 hover:border-sky-300 transition-all">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-xl font-bold mb-2 text-slate-800">Hecho por migrantes</h3>
              <p className="text-slate-600">
